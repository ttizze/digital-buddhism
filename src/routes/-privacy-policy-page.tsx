...
export default function PrivacyPolicyPage() {
		...
		},
		{
			...
			body: (
				<p>
					...
					six (6) months after deletion unless longer retention is required by
					law (e.g. tax records) or our legitimate interests (e.g. security
					logs).
				</p>
			),
		},
	...
	return (
		<LegalPage locale={locale} sections={sections} title="Privacy Policy" />
	);
}
